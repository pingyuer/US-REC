"""Transformer attention-map analysis utilities.

Functions for computing per-layer token-similarity statistics and
per-head attention-entropy curves from ViT-style models.

Usage::

    from viz.attention import get_records, get_records2
    rtoken1, rtoken2, rtoken3, rmap1, rmap2, rmap3 = get_records(ftokens, attmaps)
"""

from matplotlib.cbook import simple_linear_interpolation  # noqa: F401
import numpy as np
import torch
